 ...
 *
 * Flat grid of all projects — same blog-card style as the Portfolio page but
 * with no filter tabs. Placeholder items (same 33 as the Portfolio grid) until
 * real project photos are added. Each card links to /project/<slug>/.
 *
 * @package Seawinds
 */
	...
	<div class="sw-container">
		<div class="sw-pf__grid sw-stagger">
			...
			foreach ( $sw_items as $item ) :
				$primary = $item['cats'][0];
				?>
				<a href="<?php echo esc_url( home_url( '/project/' . $item['slug'] . '/' ) ); ?>" class="sw-pf-card sw-animate" data-anim="fadeUp">
