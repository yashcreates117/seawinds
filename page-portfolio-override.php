 ...
 *
 * This file is force-loaded by seawinds_template_router() and
 * seawinds_portfolio_override_template() in functions.php for ANY request to
 * /portfolio/ — whether WordPress resolves it as the Portfolio PAGE, the project
 * CPT archive, or an Elementor-intercepted page. All content here is
 * self-contained (hardcoded arrays, not the main loop), so it renders correctly
 * in every case.
 *
 * @package Seawinds
 */
...
/*
 * Portfolio items — 33 total across four filterable categories:
 *   events-exhibition | display-stands | signage | graphics
 * Items may belong to more than one category ('cats' array); the FIRST entry is
 * the primary label shown on the card. Each card links to /portfolio/<slug>/.
 */
$sw_cat_labels = array(
...
$sw_items = array(
	...
	array( 'title' => 'Neon Signs',        'slug' => 'neon-signs',                      'cats' => array( 'signage' ),                             'img' => 'https://seawindsadvertising.com/wp-content/uploads/2025/05/neon-tunnel-dubai-scaled-1.jpg' ),
	...
	// --- Graphics ---
	array( 'title' => 'In & Out Graphics Branding', 'slug' => 'indoor-outdoor-graphics-branding', 'cats' => array( 'graphics' ),                  'img' => 'https://seawindsadvertising.com/wp-content/uploads/2021/08/Screenshot-2024-12-13-121330-1.png' ),
	...
	<div class="sw-container">
		<div class="sw-pf__grid sw-stagger" id="sw-portfolio-grid">
			...
			foreach ( $sw_items as $item ) :
				$primary = $item['cats'][0];
				?>
				<a href="<?php echo esc_url( home_url( '/portfolio/' . $item['slug'] . '/' ) ); ?>" class="sw-pf-card sw-animate" data-anim="fadeUp" data-cat="<?php echo esc_attr( implode( ' ', $item['cats'] ) ); ?>">
